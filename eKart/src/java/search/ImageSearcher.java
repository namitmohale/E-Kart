...
//Rajesh finout search function(take 4 argumentes)
    //return the imgeresult as list
    ...
    public List<ImageResult> rankedSimilarity(Index queryIndex, ClusterReader reader,
        ...
        for (Index index : filteredIndexs) {
            ...
            try {
              ...
              //  imageResult.setBufferedImage(GraphicsUtilities.resizeImage(bufferedImage, Constants.THUMB_WIDTH,Constants.THUMB_HEIGHT));
              imageResult.setBufferedImage(GraphicsUtilities.resizeImage(bufferedImage, 200,200));
