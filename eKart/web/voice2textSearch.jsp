...
<html>
    ...
    <body>
        ...
        <div class="breadcrumbs">
            <div class="container main">
                <ul>
                    <li><a href="index.jsp">Home</a></li><li>&#47;</li><li class="active"><a href="voice2textSearch.jsp">Voice Search</a></li>
                </ul>
            </div>	
        </div>
...
<!-- Search Form -->
<form id="labnol" method="get" action="voice-search-result.jsp">
  <div class="speech">
                        ...
                        <div class="span3 footer-col">
                            <div class="widget-info">
                                ...
                                <div class="widget-content">
                                    ...
                                    <br/>
                                    <p>Store Location: <span>NeurCart</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
