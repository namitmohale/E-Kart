            ...
            <div class="main_content">
                <div class="container main product_style">
                    ...
                    <center> 
                        ...
                        <table style ="border: #0044cc solid thin ">
                             <tr style ="border: #0044cc solid thin "><td style ="border: #0044cc solid thin ">ProductID</td> <td>ProductName</td>
                            <td style ="border: #0044cc solid thin ">ProductColor</td>
                              <td style ="border: #0044cc solid thin ">Manufacture </td>
                                <td style ="border: #0044cc solid thin ">ProductPrice</td>
                                <td style ="border: #0044cc solid thin ">ProductCategoryID</td>  
                            </tr>
                            <tr> 
                                <%  Connection con = null;
                                    ResultSet rs = null;
                            ...
                            <tr style ="border: #0044cc solid thin "><td><%=rs.getString("ProductID")  %>  </td> <td style ="border: #0044cc solid thin "><%=rs.getString("ProductName")  %>  </td>
                            <td style ="border: #0044cc solid thin "><%=rs.getString("ProductColor")  %>  </td>
                              <td style ="border: #0044cc solid thin "><%=rs.getString("Manufacture")  %>  </td>
                                <td style ="border: #0044cc solid thin "><%=rs.getString("ProductPrice")  %>  </td>
                                <td style ="border: #0044cc solid thin "><%=rs.getString("ProductCategoryID")  %>  </td>  
                            </tr>
                                <%    }
                                        st.close();
                                        con.close();
