    ...
    <body>
        ...
        <div class="main_content">
            <div class="container main product_style">
                <form action="payment" method="post"  name="recharge">

                    <table >
                        <tr><td style="height: 30px;font-size: large;" >Total Amount Pay: </td><td style="height: 30px;font-size: large;" >
                                <INPUT type="text" id="txtamt" name="txtamt"  value="<%= request.getParameter("aaammmtt")%>" readonly/></td><br/> </tr>
                        <br/>
                        <tr  style="height: 30px;font-size: large;">
                            <td > Select Bank:</td>  <td><select name="bank">
                        ...
                        <tr  style="height: 20px;font-size: large;">
                            <td> Enter Account No/Card NO</td>
                            <td> <input type="text" name="accno"/></td>
                        </tr>

                        <tr  style="height: 30px;font-size: large;">
                            <td> Enter secret pin</td>
                            <td>  <input type="password" name="pin" /></td>
                        </tr>
                        <tr  style="height: 30px;font-size: large;"><td colcolspan="4" align="right">        <br/> <input type="submit" id="submit"  value="    Pay   " name="submit" /></td></tr>
                    </table>
