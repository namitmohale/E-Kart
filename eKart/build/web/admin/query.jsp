...
<html>
    ...
    <body>
        ...
        <div class="breadcrumbs">
            <div class="container main">
                <ul>
                    <li><a href="query.jsp">Query</a></li><li>&#47;</li><li class="active"><a href="query.jsp">Query</a></li>
                </ul>
            </div>	
        </div>
        ...
        <div class="main_content">
            <div class="container main product_style">
              <h1 align="center"> Customer Solution and Query!</h1>
              <center><span>
            ...
            <div class="container main product_style">
                <div class="container main">
                    <div class="row">
                        ...
                        <form id="srchCust" method="get" action="query.jsp">
