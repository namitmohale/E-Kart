            ...
            <div class="container main product_style">
                <div class="container main">
                    <div class="row">
                            ...
                            <h5 class="title-wrap">
                                Find  Customer's Record
                            </h5>
                            <div class="line"></div>

                           
                                <form id="srchCust" method="get" action="userlist.jsp">
                            ...
                            %>
                                ...
                                <table width="95%" style="border: solid red"  cellspacing="1">
                                    ...
                                    <th align="left"><H5>First Name</H4></th>
                                    <th align="left"><H5>Last Name</H5></th>
                                    <th align="left"><H5>City</H5></th>
                                    <th align="left"><H5>Country</H5></th>
                                    </tr>
 <%
                                                            Connection con = null;
                                                            ...
                                                            try {
                                                                ...
                                                                String query = "select * from users where "+request.getParameter("filter")+" like '"+request.getParameter("phrase")+"%'";
                                                                ...
                                                                %>
                             	    <tr>
                                        <td><%="<a href=\"ViewCustomerDetails.jsp?id=" +rst.getString("UserID") +"\" >" + rst.getString("UserEmail") + "</a>" %></td>
	      <td ><%=rst.getString("UserFirstName") %></td>
	      <td><%=rst.getString("UserLastName") %></td>
	      <td><%=rst.getString("UserCity") %></td>
	      <td><%=rst.getString("UserCountry")%></td>
	    </tr>
<%
		}
%>
