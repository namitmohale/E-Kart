                        ...
                        <ul id="Parks" class="just list">
                            <%
                               ...
                               String cat=request.getParameter("catid");
                                ...
                                try {
                                    ...
                                    String query = "SELECT * FROM product where ProductCategoryID='"+cat+"'";
                            ...
                            <li class="mix northeast camping climbing fishing swimming mix_all" data-name="Acadia" data-area="47452.80">
                                ...
                                <div class="meta product_description">
                                    <div class="title"><%=rst.getString("ProductName")%></div>
                                    <div class="content">Product Color : <%=rst.getString("ProductColor")%> , Material : <%=rst.getString("Material")%> , Manufacture : <%=rst.getString("Manufacture")%>    </div>
                                </div>
                                <div class="meta product_description">
